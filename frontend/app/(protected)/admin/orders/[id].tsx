...
export default function OrderDetailsAdmin() {
  ...
  return (
    <ScrollView>
      <View className="w-11/12 mx-auto py-5 gap-4">
        ...
        {order.dealer && (
          <View className="bg-white rounded-xl shadow-md shadow-black px-3 py-4">
            <Text className="text-lg font-bold text-center pb-2 mb-3 border-b border-b-gray-200">
              Información del Repartidor
            </Text>

            <View className="flex-row gap-4">
              <Icon name="person-biking" type="FontAwesome6" size={50} />

              <View className="gap-2 flex-1">
                <View className="flex-row gap-1 flex-wrap">
                  <Text className="font-semibold">Nombre:</Text>
                  <Text className="text-base">{order.dealer.name}</Text>
                </View>

                <View className="flex-row gap-1 flex-wrap">
                  <Text className="font-semibold">Correo Electrónico:</Text>
                  <Text className="text-base">{order.dealer.email}</Text>
                </View>

                <View className="flex-row gap-1 flex-wrap">
                  <Text className="font-semibold">Telefono:</Text>
                  <Text className="text-base">{order.dealer.vehicle}</Text>
                </View>
              </View>
            </View>
          </View>
        ...
        <View className="bg-white rounded-xl shadow-md shadow-black px-3 py-4">
          ...
          <View className="flex-row gap-4">
            <Icon name="person-circle" type="Ionicons" size={60} />
